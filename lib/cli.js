...
var argv = yargs
    ...
    .command('report <glob> [options]', 'Summarize the content of report files.')
...
//    })
    ...
    .describe('threads', 'The amount of threads to use to run tests.')
    .describe('out', 'The location to write output to.')
    .describe('type', 'The type of reporter to output')
