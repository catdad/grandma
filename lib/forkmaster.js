...
function start(opts, callback) {
    ...
    // TODO onWorkerMessage should take a real ID
    // or remove ID, since it's only used for debug
    workers.on('message', handlers.onWorkerMessage(0));
