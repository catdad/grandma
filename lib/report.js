...
function Reporter() {
    ...
    this.box = function boxplotReporter(input, output, done) {
        ...
        function lengthPercents(opts) {
            ...
            var p1 = (opts['25'] - opts.min) / totalLength;
            var p2 = (opts.median - opts.min) / totalLength;
            var p3 = (opts['75'] - opts.min) / totalLength;
            var p4 = 1;
        ...
        readJsonStats(input, function(err, jsonSummary) {
            ...
            _.times(round(l1), addWisker);
            
            addBreak();
            
            _.times(round(l2), addBox);
            
            addBreak();
            
            _.times(round(l3), addBox);
            
            addBreak();
            
            _.times(round(l4), addWisker);
            ...
            output.write([str1, str2, str3].join('\n') + '\n');
