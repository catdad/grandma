...
function validateOpts(opts) {
    ...
    try {
        isStream.validateStream(opts.input, 'readable', 'no readable input stream defined');
        isStream.validateStream(opts.output, 'writable', 'no writable output stream defined');
    } catch(err) {
        return err;
    }
